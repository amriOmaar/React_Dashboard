...
function Register(){
    ...
    const submitForm = (e) =>{
        ...
        if(registerObj.name.trim() === "")return setErrorMessage("Username is required! (use any value)")
                ...
                <div className='py-2 px-12'>
                    ...
                    <form onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className="mb-4">
                            ...
                            <InputText defaultValue={registerObj.fullName} updateType="fullName" containerStyle="mt-4" labelTitle="Full Name" updateFormValue={updateFormValue}/>
